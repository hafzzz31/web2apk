...
class _ProfilePageState extends State<ProfilePage> {
  ...
  // -> TAMBAHKAN CONTROLLER VIDEO DI SINI
  ...
  // -> TAMBAHKAN DISPOSE UNTUK VIDEO AGAR TIDAK MEMORY LEAK
  @override
  void dispose() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // -> GANTI BODY MENJADI STACK UNTUK MENUMPUK VIDEO
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: _videoController.value.isInitialized
                ...
                : Container(color: bgDark), // Warna fallback sebelum video loading
          ),
          
          // 2. LAYER OVERLAY GELAP (Agar teks dan tombol mudah terbaca)
          Positioned.fill(
            child: Container(
              color: bgDark.withOpacity(0.85), // Atur opacity (0.8 - 0.9) sesuai kebutuhan
            ),
          ),

          // 3. LAYER UI KONTEN ASLI
                          ...
                          child: ClipOval(
                            child: _profileImage != null
                              ...
                              fit: BoxFit.cover,
                                ...
                                : Icon(
                              FontAwesomeIcons.userAstronaut.toIcon(),
                              size: 50,
