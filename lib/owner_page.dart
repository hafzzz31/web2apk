...
class _OwnerPageState extends State<OwnerPage> {
  ...
  final List<String> roleOptions = ['reseller', 'member', 'partner', 'tk', 'moderator'];
  ...
  final Color primaryRed = const Color(0xFFB0B0B0);
  final Color accentRed = const Color(0xFFE0E0E0);
  ...
  Widget _imagePickerOption({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Icon(icon, color: accentRed, size: 32),
  ...
  Future<void> _editUser() async {
    ...
    try {
      final url = Uri.parse(
        'http://hoxtenhafz.jscloud.my.id:2001/editUser?key=$sessionKey&username=$u&addDays=$d',
      );
  ...
  Widget _buildGlassCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: borderGlass),
        boxShadow: [
          BoxShadow(color: primaryRed.withOpacity(0.1), blurRadius: 15, offset: Offset(0, 5)),
        ],
      ),
      child: Column(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    ...
                                    color: _buktiImage != null ? Colors.greenAccent : accentRed,
                                    size: 20,
                                  ),
