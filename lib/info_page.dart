...
class _InfoPageState extends State<InfoPage> {
  ...
  // --- TEMA WARNA MERAH (Consistent) ---
  final Color bgDark = const Color(0xFF121212); // Dark background (Abu-abu Gelap)
  final Color primaryRed = const Color(0xFF9E9E9E); // Primary Silver
  final Color accentRed = const Color(0xFFE0E0E0); // Bright accent Silver
  ...
  Future<void> _fetchServerInfo() async {
    try {
      final res = await http.get(
        Uri.parse('http://hoxtenhafz.jscloud.my.id:2001/getServerInfo?key=${widget.sessionKey}'),
      );
  ...
  Future<void> _checkApiPing() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://hoxtenhafz.jscloud.my.id:2001/ping?key=${widget.sessionKey}'),
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> rulesList = [
      ...
      },
      {
        ...
        "desc": "Dilarang merusak atau menurunkan harga yang telah ditentukan (banting harga) di bawah ketentuan RDVSP."
      },
    ];
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.gavel, color: Color(0xFFFF5252), size: 20),
                ),
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Icon(Icons.warning_amber_rounded, color: accentRed, size: 28),
            ...
            Center(
              child: Column(
                children: [
                  Icon(Icons.shield_moon_rounded, color: accentRed, size: 30),
                  const SizedBox(height: 12),
                  Text(
                    "Peraturan ini dibuat untuk menjaga keamanan, kenyamanan, dan kestabilan ekosistem RDVSP App. Dengan menggunakan aplikasi ini, pengguna dianggap telah menyetujui seluruh peraturan di atas.",
                    style: TextStyle(
                      color: textGrey,
                      fontSize: 12,
