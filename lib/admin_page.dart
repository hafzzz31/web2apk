...
class _AdminPageState extends State<AdminPage> {
  ...
  final List<String> roleOptions = ['member', 'reseller', 'partner', 'owner', 'moderator', 'tk'];
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://serverpterodactyl.szxennofficial.my.id:3018/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://serverpterodactyl.szxennofficial.my.id:3018/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      ...
      final url = Uri.parse('http://serverpterodactyl.szxennofficial.my.id:3018/submitPending');
  ...
  Future<void> _editUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://serverpterodactyl.szxennofficial.my.id:3018/editUser?key=$sessionKey&username=$username&day=$day'),
      );
      final data = jsonDecode(res.body);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text('Bisa buat Member, Reseller, Partner, Owner, TK, Moderator, Admin — Permanen',
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        child: isLoading
                            ...
                            : Text('CREATE ACCOUNT', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, letterSpacing: 1)),
                      ),
                    ),
                  ],
                ),
